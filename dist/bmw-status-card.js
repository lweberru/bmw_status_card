 ...
 */class rt extends w{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let a=s._$litPart$;if(void 0===a){const t=i?.renderBefore??null;s._$litPart$=a=new Q(e.insertBefore(I(),t),t,void 0,i??{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return V}}rt._$litElement$=!0,rt.finalized=!0,nt.litElementHydrateSupport?.({LitElement:rt});const ot=nt.litElementPolyfillSupport;ot?.({LitElement:rt}),(nt.litElementVersions??=[]).push("4.2.2");const lt="bmw-status-card",dt="vehicle-status-card",ct="High-quality photo of a {year} {color} {make} {model} {series} {trim} {body}, {angle}, clean studio background, realistic, sharp details.";class ht extends rt{constructor(){super(...arguments),this._loading=!1}static{this.properties={hass:{attribute:!1},_config:{state:!0},_vehicleConfig:{state:!0},_error:{state:!0},_loading:{state:!0},_vehicleInfo:{state:!0}}}static{this.styles=n`
  ...
  `}set hass(t){this._hass=t,this._ensureConfig()}get hass(){return this._hass}setConfig(t){this._config=t,this._vehicleConfig=void 0,this._error=void 0,t?.bmw_home_device_id&&t?.bmw_cardata_device_id||(this._error="bmw_home_device_id und bmw_cardata_device_id sind erforderlich."),this._vehicleInfo=void 0,this._entityEntriesCache=void 0,this._deviceEntriesCache=void 0,this._ensureVehicleCardLoaded(),this._ensureConfig()}updated(){const t=this.renderRoot.querySelector(dt);if(t&&this.hass&&(t.hass=this.hass,this._vehicleConfig)){const e=this._hash(JSON.stringify(this._vehicleConfig));this._lastVehicleConfigKey!==e&&(this._lastVehicleConfigKey=e,t.setConfig(this._vehicleConfig))}this._maybeRefreshImagesOnStatusChange()}getCardSize(){return 6}static getConfigElement(){return document.createElement("bmw-status-card-editor")}static getStubConfig(){return{type:`custom:${lt}`,bmw_home_device_id:"",bmw_cardata_device_id:""}}async _ensureVehicleCardLoaded(){if(!this._config?.vehicle_status_card_resource)return;if(customElements.get(dt))return;document.querySelector(`script[data-bmw-status-card="${this._config.vehicle_status_card_resource}"]`)||await new Promise((t,e)=>{const i=document.createElement("script");i.type="module",i.src=this._config.vehicle_status_card_resource,i.dataset.bmwStatusCard=this._config.vehicle_status_card_resource,i.addEventListener("load",()=>t()),i.addEventListener("error",()=>e()),document.head.appendChild(i)})}async _ensureConfig(){if(this.hass&&this._config&&!this._loading&&!this._vehicleConfig&&this._config.bmw_home_device_id&&this._config.bmw_cardata_device_id){this._loading=!0,this._vehicleConfig=void 0;try{console.debug("[bmw-status-card] building config");const t=[this._config.bmw_home_device_id,this._config.bmw_cardata_device_id].filter(Boolean),e=await this._getEntityRegistry(),i=await this._getDeviceRegistry(),s=this._buildEntityInfo(e,t),a=this._buildVehicleInfo(i,s);this._vehicleInfo=a;const n=await this._resolveImages(a),r=this._buildVehicleStatusCardConfig(s,n);this._vehicleConfig=this._mergeVehicleConfig(r,this._config.vehicle_status_card),this._error=void 0}catch(t){this._error=t?.message||String(t),console.error("[bmw-status-card] config build failed:",t)}finally{this._loading=!1,this.requestUpdate()}}}_maybeRefreshImagesOnStatusChange(){if(!this._config?.image||"ai"!==this._config.image.mode)return;const t=this._config.image.ai||{};if(!1!==t.generate_on_demand&&!t.generate_request_id)return;const e=this._getVehicleStatusLabel()||"unknown";this._lastImageStatus!==e&&(this._lastImageStatus=e,this._vehicleConfig=void 0,this._ensureConfig())}_toYaml(t,e=0){const i="  ".repeat(e);if(null==t)return"null";if("string"==typeof t){if(""===t||/[:#\-?{}[\],&*!|>'"%@`\n\r\t]/.test(t)){return`"${t.replace(/"/g,'\\"')}"`}return t}if("number"==typeof t||"boolean"==typeof t)return String(t);if(Array.isArray(t))return t.length?t.map(t=>{if(null!==t&&"object"==typeof t){const s=this._toYaml(t,e+1);return`${i}-\n${s}`}return`${i}- ${this._toYaml(t,e+1).trimStart()}`}).join("\n"):"[]";if("object"==typeof t){const s=Object.entries(t).filter(([,t])=>void 0!==t);return s.length?s.map(([t,s])=>{if(null!==s&&"object"==typeof s){const a=this._toYaml(s,e+1);return`${i}${t}:\n${a}`}return`${i}${t}: ${this._toYaml(s,e+1).trimStart()}`}).join("\n"):"{}"}return String(t)}async _getEntityRegistry(){if(this._entityEntriesCache)return this._entityEntriesCache;const t=await this.hass.callWS({type:"config/entity_registry/list"});return this._entityEntriesCache=t,t}async _getDeviceRegistry(){if(this._deviceEntriesCache)return this._deviceEntriesCache;const t=await this.hass.callWS({type:"config/device_registry/list"});return this._deviceEntriesCache=t,t}_buildEntityInfo(t,e){const i=new Set(e);return t.filter(t=>t.device_id&&i.has(t.device_id)).filter(t=>!t.disabled_by).map(t=>{const e=this.hass.states[t.entity_id],i=t.entity_id.split(".")[0],s=e?.attributes?.friendly_name||t.original_name||t.entity_id;return{entity_id:t.entity_id,domain:i,name:s,device_class:e?.attributes?.device_class,unit:e?.attributes?.unit_of_measurement,state:e?.state,attributes:e?.attributes||{}}})}_extractVehicleInfoFromAttributes(t){const e={};for(const i of t){const t=i.attributes||{},s=t.vehicle_basic_data||t.vehicleBasicData,a=t.vehicle_basic_data_raw||t.vehicleBasicDataRaw;s&&"object"==typeof s&&(e.model=e.model||this._toNonEmptyString(s.model_name),e.series=e.series||this._toNonEmptyString(s.series),e.color=e.color||this._toNonEmptyString(s.color),e.body=e.body||this._toNonEmptyString(s.body_type),e.year=e.year||this._extractYear(s.construction_date)),a&&"object"==typeof a&&(e.make=e.make||this._toNonEmptyString(a.brand),e.model=e.model||this._toNonEmptyString(a.modelName)||this._toNonEmptyString(a.modelRange)||this._toNonEmptyString(a.series),e.series=e.series||this._toNonEmptyString(a.series)||this._toNonEmptyString(a.seriesDevt),e.color=e.color||this._toNonEmptyString(a.colourDescription)||this._toNonEmptyString(a.colourCodeRaw),e.body=e.body||this._toNonEmptyString(a.bodyType),e.year=e.year||this._extractYear(a.constructionDate))}return e}_extractYear(t){if(t){if("number"==typeof t)return String(t);if("string"==typeof t){const e=t.match(/(19|20)\d{2}/);return e?e[0]:void 0}}}_toNonEmptyString(t){if(null==t)return;const e=String(t).trim();return e.length?e:void 0}_buildVehicleInfo(t,e){const i=this._config?.vehicle_info||{},s=[this._config?.bmw_home_device_id,this._config?.bmw_cardata_device_id],a=t.filter(t=>s.includes(t.id)),n=this._extractVehicleInfoFromAttributes(e),r=a.find(t=>t.manufacturer)?.manufacturer||"BMW",o=a.find(t=>t.model)?.model,l=a.find(t=>t.name)?.name,d=this._findEntityByKeywords(e,["model","vehicle_model","car_model"]),c=this._findEntityByKeywords(e,["series","line"]),h=this._findEntityByKeywords(e,["year","model_year"]),_=this._findEntityByKeywords(e,["color","colour"]),u=this._findEntityByKeywords(e,["trim","package","edition"]),p=this._findEntityByKeywords(e,["body","body_type"]),g=t=>{if(!t)return;const e=this.hass.states[t]?.state;return e&&"unknown"!==e&&"unavailable"!==e?e:void 0};return{make:i.make||n.make||r,model:i.model||n.model||g(d)||o,series:i.series||n.series||g(c),year:i.year||n.year||g(h),color:i.color||n.color||g(_),trim:i.trim||n.trim||g(u),body:i.body||n.body||g(p),name:i.name||n.name||l}}async _resolveImages(t){const e=this._config?.image;if(!e||"off"===e.mode)return[];if("static"===e.mode&&e.static_urls?.length)return e.static_urls;if("ai"===e.mode&&e.ai){const i=e.ai.provider||"ha_ai_task";return"openai"!==i&&"gemini"!==i||e.ai.api_key?(console.debug("[bmw-status-card] generating AI images",e.ai),this._generateAiImages(t,e.ai)):(console.warn("[bmw-status-card] image.ai.api_key fehlt – überspringe Bildgenerierung."),[])}return[]}async _generateAiImages(t,e){const i=e.provider||"ha_ai_task",s=e.cache_hours??24,a=this._buildImageCacheKey(t,e),n=this._buildPrompts(t,e),r=e.count??1,o=e.max_images??8,l=!1!==e.generate_on_demand,d=this._getVehicleStatusLabel()||"unknown",c=e.upload??("openai"===i||"gemini"===i||"ha_ai_task"===i),h="ha_ai_task"===i||c;try{const t=localStorage.getItem(a);if(t){const e=JSON.parse(t),i=(Date.now()-e.timestamp)/36e5,a=e.images?.some(t=>!this._isCacheableImageUrl(t));if(e.images?.length&&i<=s&&!a&&e.status===d)return e.images}}catch(t){}if(l&&!e.generate_request_id)return[];let _=[];for(const t of n){if(_.length>=o)break;const s=o-_.length,a=Math.min(r,s);if(a<=0)break;"openai"===i?_.push(...await this._fetchOpenAiImages(t,e,a)):"gemini"===i?_.push(...await this._fetchGeminiImages(t,e,a)):"ha_ai_task"===i?_.push(...await this._fetchHaAiTaskImages(t,e,a)):_.push(...await this._fetchGenericImages(t,e,a))}if(_.length&&h&&(_=await this._uploadImagesIfNeeded(_,e)),_.length&&_.every(t=>this._isCacheableImageUrl(t)))try{localStorage.setItem(a,JSON.stringify({timestamp:Date.now(),images:_,status:d}))}catch(t){}return _}_buildPrompts(t,e){const i=e.prompt_template||ct;if(e.prompts&&e.prompts.length)return e.prompts.map(e=>this._buildPrompt(t,e));return(e.views?.length?e.views:["front 3/4 view","rear 3/4 view","side profile","front view","rear view"]).map(e=>this._buildPrompt(t,i,e))}_buildPrompt(t,e,i){const s=e||ct,a=this._getVehicleStatusLabel(),n=this._getStatusScene(a),r={"{make}":t.make||"BMW","{model}":t.model||"","{series}":t.series||"","{year}":t.year||"","{color}":t.color||"","{trim}":t.trim||"","{body}":t.body||"","{angle}":i||"","{status}":n||a||""};let o=s;return Object.entries(r).forEach(([t,e])=>{const i=e?.trim();o=o.replaceAll(t,i||"")}),i&&!s.includes("{angle}")&&(o=`${o} ${i}`),!n&&!a||s.includes("{status}")||(o=n?`${o} ${n}`:`${o} status: ${a}`),o.replace(/\s+/g," ").trim()}_getStatusScene(t){if(!t)return;const e=this._normalizeText(t);return e.includes("driving")?"driving on the road, motion blur, dynamic scene":e.includes("parking")||e.includes("parked")?"parked in a parking lot, stationary":e.includes("standing")||e.includes("stand")?"stopped at a traffic light or intersection, stationary":void 0}async _fetchOpenAiImages(t,e,i){if(!e.api_key)throw new Error("image.ai.api_key fehlt (OpenAI).");const s=e.endpoint||"https://api.openai.com/v1/images/generations",a={model:e.model||"gpt-image-1",prompt:t,size:e.size||"1024x1024",n:i},n=await fetch(s,{method:"POST",headers:{Authorization:`Bearer ${e.api_key}`,"Content-Type":"application/json"},body:JSON.stringify(a)});if(!n.ok){const t=await n.text();throw new Error(`OpenAI Fehler: ${n.status} ${t}`)}const r=await n.json();return(r?.data||[]).map(t=>t.url||t.b64_json).filter(Boolean).map(t=>t.startsWith("http")?t:`data:image/png;base64,${t}`)}async _fetchGeminiImages(t,e,i){if(!e.api_key)throw new Error("image.ai.api_key fehlt (Gemini).");const s=e.model||"imagen-3.0-generate-002",a=e.endpoint||`https://generativelanguage.googleapis.com/v1beta/models/${s}:generateContent?key=${e.api_key}`,n=e=>{const s={contents:[{role:"user",parts:[{text:t}]}],generationConfig:{candidateCount:i}};return e&&(s.responseModalities=["IMAGE"]),s},r=e.request_body||n(!0),o=async t=>await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});let l=await o(r),d="";if(!l.ok){d=await l.text();if(!(!e.request_body&&(d.includes("response_modalities")||d.includes("responseModalities")||d.includes("imageGenerationConfig")||d.includes("generation_config"))))throw new Error(`Gemini Fehler: ${l.status} ${d}`);if(l=await o(n(!1)),!l.ok){const t=await l.text();throw new Error(`Gemini Fehler: ${l.status} ${t}`)}}const c=await l.json(),h=c?.candidates||[],_=[];if(Array.isArray(h)&&h.forEach(t=>{"SAFETY"===t?.finishReason&&console.warn("[bmw-status-card] Gemini Bild durch Safety-Filter blockiert.");(t?.content?.parts||[]).forEach(t=>{const e=t.inlineData||t.inline_data;if(e?.data){const t=e.mimeType||"image/png";_.push(`data:${t};base64,${e.data}`)}})}),_.length)return _;const u=c?.predictions||c?.images||c?.data||[];return Array.isArray(u)?u.map(t=>{const e=t.bytesBase64Encoded||t?.image?.bytesBase64Encoded||t?.b64_json;return e?`data:image/png;base64,${e}`:"string"==typeof t&&t.startsWith("http")?t:t?.url?t.url:null}).filter(Boolean):[]}async _fetchHaAiTaskImages(t,e,i){if(!this.hass)throw new Error("Home Assistant nicht verfügbar.");const s=this._normalizeEntityId(e.ha_entity_id),a={task_name:this._vehicleInfo?.name||this._config?.vehicle_info?.name||"BMW Status Card",instructions:t};let n;s&&(a.entity_id=s);try{n=await this.hass.callWS({type:"call_service",domain:"ai_task",service:"generate_image",service_data:a,return_response:!0})}catch(t){throw new Error(`ai_task Fehler: ${t?.message||String(t)}`)}const r=n?.response??n?.result??n;return(await this._extractHaAiTaskUrls(r)).filter(Boolean)}async _uploadImagesIfNeeded(t,e){if(!this.hass)return t;const i=e.provider||"ha_ai_task",s=this._normalizeUploadPath(e.upload_path),a=[];for(const e of t){let t,n,r;if(this._isHttpUrl(e))t=e;else{const t=this._parseDataUrl(e);if(t)n=t.data,r=t.mimeType;else if(e.startsWith("/")){const t="ha_ai_task"===i?this._normalizeHaAiTaskUrl(e):e,s=await this._fetchAsDataUrl(t),o=s?this._parseDataUrl(s):null;if(!o){if("ha_ai_task"===i)continue;a.push(e);continue}n=o.data,r=o.mimeType}else{if("ha_ai_task"!==i||!e.startsWith("ai_task/")){if("ha_ai_task"===i)continue;a.push(e);continue}{const t=this._normalizeHaAiTaskUrl(e),i=await this._fetchAsDataUrl(t),s=i?this._parseDataUrl(i):null;if(!s)continue;n=s.data,r=s.mimeType}}}const o=this._guessImageExtension(t,r),l=t||n||e,d=`${this._hash(l)}.${o}`;try{const i=await this.hass.callWS({type:"call_service",domain:"upload_file",service:"upload_file",service_data:{path:s,filename:d,...t?{url:t}:{data_base64:n}},return_response:!0}),r=i?.response??i?.result??i,o=r?.local_url||r?.url||r?.local_path;a.push(this._normalizeLocalUploadUrl(o)||e)}catch(t){"ha_ai_task"!==i&&a.push(e)}}return a}_normalizeUploadPath(t){const e=(t||"www/upload_file").replace(/^\/+/,"").replace(/\/+$/,"");return e.startsWith("www/")?e:`www/${e}`}_normalizeLocalUploadUrl(t){if(!t)return;const e=t.trim();return e?e.startsWith("/local/")?e:e.startsWith("local/")?`/${e}`:e.startsWith("www/")?`/local/${e.replace(/^www\//,"")}`:e.includes("/www/")?`/local/${e.split("/www/")[1]}`:e:void 0}_parseDataUrl(t){if(!t.startsWith("data:"))return null;const e=t.match(/^data:([^;]+);base64,(.*)$/);return e?{mimeType:e[1],data:e[2]}:null}async _fetchAsDataUrl(t){const e=async t=>{try{const e=await fetch(t,{credentials:"same-origin"});if(!e.ok)return null;const i=await e.blob();return await new Promise((t,e)=>{const s=new FileReader;s.onloadend=()=>t(String(s.result||"")),s.onerror=()=>e(s.error),s.readAsDataURL(i)})}catch(t){return null}},i=[t],[s]=t.split("?");s&&s!==t&&i.push(s),s.startsWith("/ai_task/")?i.push(`/api${s}`):s.startsWith("/api/ai_task/")&&i.push(s.replace("/api/ai_task/","/ai_task/"));for(const t of i){const i=await e(t);if(i)return i}return null}_guessImageExtension(t,e){if(e){if(e.includes("png"))return"png";if(e.includes("jpeg")||e.includes("jpg"))return"jpg";if(e.includes("webp"))return"webp"}if(t){const e=t.match(/\.(png|jpg|jpeg|webp)(\?|$)/i);if(e)return e[1].toLowerCase().replace("jpeg","jpg")}return"png"}_isHttpUrl(t){return t.startsWith("http://")||t.startsWith("https://")}_isCacheableImageUrl(t){const e=t.toLowerCase();return!e.includes("/ai_task/")&&!e.includes("authsig=")}async _extractHaAiTaskUrls(t){if(!t)return[];const e=t?.images||t?.data||t?.results||t?.result||t,i=Array.isArray(e)?e:[e],s=[];for(const t of i){if(!t)continue;if("string"==typeof t){s.push(this._normalizeHaAiTaskUrl(t));continue}const e=t.url||t.image_url||t.media_url||t.content_url||t.media?.url||t.image?.url||t.local_url||t.local_path;if(e){s.push(this._normalizeHaAiTaskUrl(String(e)));continue}const i=t.media_id||t.media_content_id||t.content_id||t.media;if(i){const t=await this._resolveMediaSourceUrl(String(i));t?s.push(this._normalizeHaAiTaskUrl(t)):s.push(`/api/media/${i}`)}}return s}_normalizeHaAiTaskUrl(t){const e=t.trim();return e?e.startsWith("http://")||e.startsWith("https://")||e.startsWith("/ai_task/")?e:e.startsWith("ai_task/")?`/${e}`:e:t}async _resolveMediaSourceUrl(t){if(this.hass&&t)try{if(t.startsWith("http"))return t;const e=await this.hass.callWS({type:"media_source/resolve",media_content_id:t});return e?.url}catch(t){return}}async _fetchGenericImages(t,e,i){if(!e.endpoint)throw new Error("image.ai.endpoint fehlt (generic).");const s=e.request_body||{prompt:t,count:i,size:e.size},a=await fetch(e.endpoint,{method:"POST",headers:{...e.api_key?{Authorization:`Bearer ${e.api_key}`}:{},"Content-Type":"application/json"},body:JSON.stringify(s)});if(!a.ok){const t=await a.text();throw new Error(`AI Fehler: ${a.status} ${t}`)}const n=await a.json(),r=this._extractByPath(n,e.response_path)||n.images||n.data||[];return Array.isArray(r)?r.map(t=>"string"==typeof t?t:t.url||t.image||t.b64_json).filter(Boolean).map(t=>t.startsWith("http")?t:`data:image/png;base64,${t}`):[]}_extractByPath(t,e){if(e)return e.split(".").reduce((t,e)=>t?t[e]:void 0,t)}_buildImageCacheKey(t,e){const i=this._getVehicleStatusLabel(),s=this._getStatusScene(i),a={vehicleInfo:t,provider:e.provider,model:e.model,size:e.size,aspect_ratio:e.aspect_ratio,count:e.count,max_images:e.max_images,upload:e.upload,upload_path:e.upload_path,prompt_template:e.prompt_template,prompts:e.prompts,views:e.views,status_label:i,status_scene:s,generate_request_id:!1!==e.generate_on_demand?e.generate_request_id:void 0};return`bmw-status-card:images:${this._hash(JSON.stringify(a))}`}_hash(t){let e=0;for(let i=0;i<t.length;i+=1)e=(e<<5)-e+t.charCodeAt(i),e|=0;return String(e)}_buildVehicleStatusCardConfig(t,e){const i=new Set,s=this._pickEntity(t,i,["lock","binary_sensor","sensor"],["lock","locked","door lock","verriegelt","schloss","türschloss"]),a=this._pickEntity(t,i,["binary_sensor","sensor"],["charging","charge","plugged","plug","charging port","connector","port","laden","lade","stecker","anschluss","ladeklappe"]),n=this._pickEntity(t,i,["sensor"],["battery health","state of health","soh","health_state","battery_health","battery health state","health state","health_state_48v","48v health","48v battery health","battery_health_state_48v"]),r=this._pickEntity(t,i,["sensor"],["state_of_charge","state of charge","soc","state_of_energy","soe","ladezustand","batteriestand","charge level","charge_level","charge level at end of trip","trip_battery_charge_level","soc bei ankunft","state_of_charge_predicted","state_of_charge_predicted_on_integration_side"]),o=this._pickEntity(t,i,["sensor"],["fuel","tank","fuel_level","kraftstoff","tankinhalt","tankfüllung","tankfuellung","kraftstoffstand","tank level","range tank level"]),l=this._pickEntity(t,i,["sensor"],["range","remaining","remaining_range","remainingrange","reichweite","restreichweite","reichweite_km","range total","total range","range_total_range","total_range","range_total_range_last_sent"]),d=this._pickEntity(t,i,["sensor"],["electric range","ev range","remaining electric range","kombi remaining electric range","elektrische reichweite","ev-reichweite"]),c=this._pickEntity(t,i,["sensor"],["fuel range","remaining fuel","tank level","kraftstoffreichweite"]),h=this._pickEntity(t,i,["sensor"],["total remaining range","total range","gesamtreichweite"]),_=this._pickEntity(t,i,["sensor","number"],["charge target","target soc","target state","charge limit","charge_limit","charge_limit_soc","ladeziel","ladegrenze","ladegrenze soc"]),u=this._pickEntity(t,i,["sensor"],["odometer","mileage","distance","travelled","kilometerstand","kilometer","odo","vehicle mileage"]),p=this._pickEntity(t,i,["sensor"],["temperature","temp","coolant","temperatur","innen","innenraum"]),g=this._pickEntity(t,i,["sensor"],["charging power","charge power","power","grid energy","ladeleistung","leistung"]),m=this._pickEntity(t,i,["sensor"],["time remaining","time to fully","time to full","remaining time","restzeit","ladezeit","verbleibend"]);this._pickEntity(t,i,["binary_sensor","sensor","switch"],["preconditioning","climatization","climate","hvac","defrost","vorklimatisierung","klimatisierung","vorheizen","klima"]);const f=this._findEntity(t,["sensor"],["preconditioning state","preconditioning activity","preconditioning status","standklima","vorklimatisierung"],new Set)?.entity_id,y=this._findEntity(t,["sensor"],["preconditioning error","preconditioning error reason","vorklimatisierung fehler","standklima fehler"],new Set)?.entity_id,v=this._findEntity(t,["sensor"],["preconditioning remaining time","preconditioning remaining","standklima rest","vorklimatisierung rest"],new Set)?.entity_id,b=this._findEntity(t,["binary_sensor","sensor"],["preconditioning engine used","remote engine running","engine used"],new Set)?.entity_id,w=this._findEntity(t,["binary_sensor","sensor"],["preconditioning engine use allowed","remote engine start allowed","engine use allowed"],new Set)?.entity_id,$=this._pickEntity(t,i,["binary_sensor","sensor"],["engine","ignition","motor","zündung","zuendung"]),E=this._pickEntity(t,i,["sensor"],["bmw_pwf_status","pwf status","pwf_status"]),k=E||this._pickEntity(t,i,["binary_sensor","sensor"],["moving","motion","driving","parking","fährt","bewegt","parked","stand","status","fahrstatus","pwf","pwf status"]),A=this._pickEntity(t,i,["binary_sensor","sensor"],["alarm","anti theft","anti-theft","diebstahl","security","alarmsystem"]),S=this._pickEntity(t,i,["sensor"],["alarm arming","alarm_arming","alarm arming state","alarm_arming_state","arming"]),C=this._detectElectrification(t,n,r,a,d,o),x="bev"===C||"phev"===C,T=this._is48vEntity(n),M=e=>{if(!e)return!1;const i=t.find(t=>t.entity_id===e);return!i||("sensor"!==i.domain||!this._isNumericState(i.state))},I=[];s&&M(s)&&I.push({type:"entity",entity:s,icon:"mdi:lock"}),a&&x&&M(a)&&I.push({type:"entity",entity:a,icon:"mdi:ev-station"});const P=[];if($&&M($)&&P.push({type:"entity",entity:$,icon:"mdi:engine"}),k&&M(k)){const t={type:"entity",entity:k,icon:"mdi:car"};E&&k===E&&(t.icon_template=this._buildPwfStatusIconTemplate(k)),P.push(t)}A&&M(A)&&P.push({type:"entity",entity:A,icon:"mdi:alarm-light"}),S&&M(S)&&P.push({type:"entity",entity:S,icon:"mdi:shield-lock",icon_template:this._buildAlarmArmingIconTemplate(S)});const z=this._pickEntities(t,i,["binary_sensor","sensor","cover"],["door","window","trunk","tailgate","boot","hood","bonnet","sunroof","roof","flap","lock","charging port","port","tür","fenster","kofferraum","heckklappe","motorhaube","schiebedach","dach","klappe","panoramadach","door state","doors overall","window state","sunroof state","sunroof tilt","tailgate door","tailgate rear window","tailgate state"]),N=this._pickEntities(t,i,["sensor"],["tire","tyre","pressure","wheel","tpms","pressure target","reifen","reifendruck","rad","solldruck","target pressure","tire pressure target"]);this._pickEntities(t,i,["sensor"],["tire temperature","tyre temperature","wheel temperature","reifentemperatur"]);const B=N.filter(t=>this._isTireTargetEntity(t)),U=N.filter(t=>!this._isTireTargetEntity(t)),O=this._pickEntities(t,i,["binary_sensor","sensor","switch"],["light","lights","headlight","lamp","running light","licht","scheinwerfer","abblendlicht","fernlicht"]),L=this._pickEntities(t,i,["binary_sensor","sensor","switch","climate"],["climate","hvac","preconditioning","standklima","vorklimatisierung","defrost","seat","steering wheel","air purification","heater","heating","cooling","klima","sitzheizung","lenkrad","heizung","kühlung","aircon","ac","klimastatus","climate timer"]),H=this._pickEntities(t,i,["sensor","binary_sensor"],["service","inspection","cbs","check control","maintenance","wartung","inspektion","servicebedarf"]),j=this._pickEntities(t,i,["sensor","device_tracker"],["navigation","destination","eta","latitude","longitude","gps","ziel","ankunft","route","routing","navi","position","lat","lon","navigationsstatus","navigationsziel","ankunftsort","ankunftsort breitengrad","ankunftsort längengrad","ankunftsort laengengrad"]),R=this._pickEntities(t,i,["sensor","binary_sensor","switch","number"],["charging","charge","plug","connector","charging mode","charging power","time to fully","charge target","laden","lade","ladeziel","ladestatus","ladekabel"]),D=[];I.length&&D.push({row_items:I,alignment:"center",no_wrap:!0}),P.length&&D.push({row_items:P,alignment:"center",no_wrap:!0});const V=[],W=O.filter(t=>M(t));W.length&&V.push({type:"group",name:"Licht",icon:"mdi:car-light-high",items:W.map(t=>({type:"entity",entity:t}))}),V.length&&D.push({row_items:V,alignment:"center",no_wrap:!0});const K=[];r&&x&&K.push({energy_level:{entity:r},range_level:d||h||l?{entity:d||h||l}:void 0,charging_entity:a||void 0,charge_target_entity:_||void 0}),!n||T&&!x||K.push({energy_level:{entity:n,max_value:100},color_template:this._buildBatteryHealthColorTemplate(n)}),o&&"bev"!==C&&K.push({energy_level:{entity:o},range_level:c||h||l?{entity:c||h||l}:void 0,color_template:this._buildLowFuelColorTemplate(o)}),!K.length&&l&&K.push({energy_level:{entity:l}});const G=t.filter(t=>"device_tracker"===t.domain).map(t=>t.entity_id),F=G[0],q=this._buildTireCardConfig(t),Y=new Set(q?.entities||[]);this._statusEntities={fuel:o,motion:k,doors:z,tires:U,tireTargets:B};const J=[],Z=[],Q=[],X=(t,e,i,s)=>{e&&t.push({entity:e,name:i,icon:s})},tt=T?"48V Batteriegesundheit":"Batteriegesundheit";if(X(Z,r,x?"Batterie":"12V Batterie","mdi:battery"),X(Z,n,tt,"mdi:battery-heart"),X(Z,o,"Kraftstoff","mdi:gas-station"),X(Z,d||h||l,"Reichweite","mdi:map-marker-distance"),X(Z,u,"Kilometerstand","mdi:counter"),X(Z,p,"Temperatur","mdi:thermometer"),x&&(X(Z,m,"Ladezeit","mdi:timer"),X(Z,g,"Ladeleistung","mdi:flash")),X(Z,k,"Fahrstatus","mdi:car"),X(Z,S,"Alarmanlage","mdi:shield-lock"),H.forEach(t=>X(Q,t)),Z.length&&(J.push({name:"Fahrzeug",icon:"mdi:car-info",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Fahrzeugstatus",items:Z}]}}),Z.forEach(t=>Y.add(t.entity))),Q.length&&(J.push({name:"Service",icon:"mdi:wrench",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Service",items:Q}]}}),Q.forEach(t=>Y.add(t.entity))),z.length){const t=this._buildDoorTemplates(z,k);J.push({name:"Öffnungen",icon:"mdi:car-door",button_type:"default",card_type:"default",notify:t.notify,notify_icon:t.notify_icon,notify_color:t.notify_color,color_template:t.color,sub_card:{default_card:[{title:"Öffnungen",items:z.map(t=>({entity:t}))}]}}),z.forEach(t=>Y.add(t))}if(q?.tire_card){const t=this._buildTirePressureTemplates(U,B);J.push({name:"Reifen",icon:"mdi:car-tire-alert",button_type:"default",card_type:"tire",notify:t.notify,notify_icon:t.notify_icon,notify_color:t.notify_color,color_template:t.color,sub_card:{tire_card:q.tire_card}}),(q.entities||[]).forEach(t=>Y.add(t))}if(x&&R.length&&(J.push({name:"Laden",icon:"mdi:ev-station",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Ladezustand",items:R.map(t=>({entity:t}))}]}}),R.forEach(t=>Y.add(t))),L.length){const t=this._buildPreconditioningTemplates(f,y,v,b,w);J.push({name:"Klima",icon:"mdi:car-defrost-front",button_type:"default",card_type:"default",notify:t.notify,notify_icon:t.notify_icon,notify_color:t.notify_color,color_template:t.color,sub_card:{default_card:[{title:"Klima",items:L.map(t=>({entity:t}))}]}}),L.forEach(t=>Y.add(t))}j.length&&(J.push({name:"Navigation",icon:"mdi:navigation",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Navigation",items:j.map(t=>({entity:t}))}]}}),j.forEach(t=>Y.add(t)));const et=[...J,...this._buildButtonCards(t,i,Y)],it=e.length?e.map(t=>({image:t})):void 0;return{type:`custom:${dt}`,name:this._vehicleInfo?.name||"BMW",indicator_rows:D.length?D:void 0,range_info:K.length?K:void 0,button_cards:et.length?et:void 0,images:it,mini_map:F?{device_tracker:F,entities:G,maptiler_api_key:this._config?.maptiler_api_key,enable_popup:!0,map_height:240,map_zoom:14,user_location:!0,use_zone_name:!0}:void 0,layout_config:{section_order:["indicators","range_info","images","mini_map","buttons"],button_grid:{columns:2,swipe:!0},images_swipe:{autoplay:!0,loop:!0,delay:6e3,speed:600,effect:"fade",height:240},range_info_config:{layout:"row"},single_tire_card:void 0}}}_buildButtonCards(t,e,i){const s=["lock","switch","button","cover","climate"],a=new Set([...e,...i?Array.from(i):[]]),n=t.filter(t=>!a.has(t.entity_id)).sort((t,e)=>{const i=s.indexOf(t.domain),a=s.indexOf(e.domain);return(-1===i?999:i)-(-1===a?999:a)}),r=[];for(const t of n){if(r.length>=12)break;s.includes(t.domain)&&(e.add(t.entity_id),a.add(t.entity_id),r.push({entity:t.entity_id,name:t.name,button_type:"default"}))}return r}_mergeVehicleConfig(t,e){if(!e)return t;const i={...t,...e};return["indicator_rows","range_info","images","button_cards"].forEach(t=>{void 0!==e[t]&&(i[t]=e[t])}),void 0!==e.mini_map&&(i.mini_map=e.mini_map),void 0!==e.layout_config&&(i.layout_config=e.layout_config),i}_pickEntity(t,e,i,s){const a=this._findEntity(t,i,s,e);if(a)return e.add(a.entity_id),a.entity_id}_pickEntities(t,e,i,s){const a=this._findEntities(t,i,s,e);return a.forEach(t=>e.add(t.entity_id)),a.map(t=>t.entity_id)}_findEntity(t,e,i,s){return this._findEntities(t,e,i,s)[0]}_findEntities(t,e,i,s){const a=i.map(t=>this._normalizeText(t));return t.filter(t=>!s.has(t.entity_id)).filter(t=>!e.length||e.includes(t.domain)).filter(t=>{if(!a.length)return!0;const e=this._normalizeText(`${t.entity_id} ${t.name} ${t.device_class??""}`);return a.some(t=>e.includes(t))}).sort((t,e)=>{const i=t.state||"",s=e.state||"";return"unknown"===i&&"unknown"!==s?1:"unknown"===s&&"unknown"!==i?-1:t.name.localeCompare(e.name)})}_normalizeText(t){return t.toLowerCase().normalize("NFD").replace(/[\0-]/g," ").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]+/g," ").trim()}_normalizeEntityId(t){if(!t)return;if(Array.isArray(t)){const e=t.length?String(t[0]).trim():"";return this._normalizeEntityId(e)}if("object"==typeof t){const e=t.entity_id??t.entityId;return this._normalizeEntityId(e)}const e=String(t).trim();if(e){if(e.includes(",")){const t=e.split(",")[0].trim();return this._normalizeEntityId(t)}if(e.includes(".")&&!/\s/.test(e))return e}}_findEntityByKeywords(t,e){return this._findEntity(t,[],e,new Set)?.entity_id}_isNumericState(t){if(null==t)return!1;if("number"==typeof t)return!Number.isNaN(t);const e=String(t).trim().replace(",",".");return!!e&&!Number.isNaN(Number(e))}_buildTireCardConfig(t){const e=e=>this._findEntity(t,["sensor"],e,new Set),i=e(["front left","front_left","row1 left","row1 wheel left"]),s=e(["front right","front_right","row1 right","row1 wheel right"]),a=e(["rear left","rear_left","row2 left","row2 wheel left"]),n=e(["rear right","rear_right","row2 right","row2 wheel right"]),r=[i,s,a,n].filter(Boolean).map(t=>t.entity_id);if(!r.length)return;return{tire_card:{title:"Reifendruck",front_left:i?{entity:i.entity_id,name:"Vorne links"}:void 0,front_right:s?{entity:s.entity_id,name:"Vorne rechts"}:void 0,rear_left:a?{entity:a.entity_id,name:"Hinten links"}:void 0,rear_right:n?{entity:n.entity_id,name:"Hinten rechts"}:void 0},entities:r}}_isTireTargetEntity(t){const e=this._normalizeText(t);return e.includes("target")||e.includes("solldruck")}_isDoorSummaryEntity(t){const e=this._normalizeText(t);return e.includes("overall")||e.includes("hood")||e.includes("tailgate")||e.includes("sunroof overall")}_getVehicleStatusLabel(){const t=this._statusEntities?.motion;if(!t||!this.hass)return;const e=this.hass.states[t]?.state;if(!e)return;const i=this._normalizeText(e);return i.includes("driving")||i.includes("fahrt")?"driving":i.includes("standing")||i.includes("stand")?"standing":i.includes("park")||i.includes("parken")?"parking":e}_buildTirePressureTemplates(t,e){const i=this._buildTirePressureTemplateBase(t,e);return i?{notify:`${i}{{ ns.state in ['warn','error'] }}`,color:`${i}{{ iif(ns.state == 'error', 'var(--error-color)', iif(ns.state == 'warn', 'var(--warning-color)', 'var(--secondary-text-color)')) }}`,notify_color:`${i}{{ iif(ns.state == 'error', 'var(--error-color)', 'var(--warning-color)') }}`,notify_icon:`${i}{{ iif(ns.state == 'error', 'mdi:alert', 'mdi:alert-circle') }}`}:{}}_buildTirePressureTemplateBase(t,e){const{pairs:i,fallback:s}=this._buildTirePairs(t,e);if(!i.length&&!s.length)return;return`{% set pairs = [${i.map(t=>`{ 'a': '${t.a}', 't': '${t.t}' }`).join(", ")}] %}{% set fallback = [${s.map(t=>`'${t}'`).join(", ")}] %}{% set ns = namespace(state='ok') %}{% for p in pairs %}{% set av = states(p['a']) | float(0) %}{% set tv = states(p['t']) | float(0) %}{% if tv > 0 and av > 0 %}{% set warn = tv * 0.9 %}{% set err = tv * 0.8 %}{% if av < err %}{% set ns.state = 'error' %}{% elif av < warn and ns.state != 'error' %}{% set ns.state = 'warn' %}{% endif %}{% endif %}{% endfor %}{% if ns.state == 'ok' %}{% for e in fallback %}{% set v = states(e) | float(0) %}{% if v > 0 and v < 180 %}{% set ns.state = 'error' %}{% elif v > 0 and v < 200 and ns.state != 'error' %}{% set ns.state = 'warn' %}{% endif %}{% endfor %}{% endif %}`}_buildDoorTemplates(t,e){const i=this._buildDoorTemplateBase(t,e);return i?{notify:`${i}{{ ns.open }}`,color:`${i}{{ iif(ns.open, 'var(--warning-color)', 'var(--secondary-text-color)') }}`,notify_color:`${i}{{ 'var(--warning-color)' }}`,notify_icon:`${i}{{ 'mdi:car-door' }}`}:{}}_buildDoorTemplateBase(t,e){if(!t.length)return;return`{% set ns = namespace(open=false) %}{% set status = states(${e?`'${e}'`:"''"}) | lower %}{% if status in ['parking','parked','standing'] %}{% for e in [${t.map(t=>`'${t}'`).join(", ")}] %}{% set s = states(e) | lower %}{% if s not in ['closed','geschlossen','secured','gesichert','locked','verriegelt','ok','aus','off','false','no','0','inactive','not_open','unknown','unavailable','none','-'] %}{% set ns.open = true %}{% endif %}{% endfor %}{% endif %}`}_buildPreconditioningTemplates(t,e,i,s,a){const n=this._buildPreconditioningTemplateBase(t,e,i,s,a);return n?{notify:`${n}{{ ns.active or ns.error }}`,color:`${n}{{ iif(ns.error, 'var(--error-color)', iif(ns.active, 'var(--success-color)', 'var(--secondary-text-color)')) }}`,notify_color:`${n}{{ iif(ns.error, 'var(--error-color)', 'var(--success-color)') }}`,notify_icon:`${n}{{ iif(ns.error, 'mdi:alert-circle', 'mdi:car-defrost-front') }}`}:{}}_buildPreconditioningTemplateBase(t,e,i,s,a){if(!(t||e||i||s||a))return;return`{% set ns = namespace(active=false, error=false) %}{% set state = states(${t?`'${t}'`:"''"}) | lower %}{% set err = states(${e?`'${e}'`:"''"}) | lower %}{% set remaining = states(${i?`'${i}'`:"''"}) | float(0) %}{% set engine = states(${s?`'${s}'`:"''"}) | lower %}{% set allowed = states(${a?`'${a}'`:"''"}) | lower %}{% if err not in ['','ok','invalid','unknown','none','-'] %}{% set ns.error = true %}{% endif %}{% if state in ['heating','cooling','ventilation','standby'] %}{% set ns.active = true %}{% endif %}{% if remaining > 0 %}{% set ns.active = true %}{% endif %}{% if engine in ['true','on','yes','1'] %}{% set ns.active = true %}{% endif %}{% if allowed in ['false','off','no','0'] and state in ['heating','cooling','ventilation'] %}{% set ns.error = true %}{% endif %}`}_detectElectrification(t,e,i,s,a,n){const r=this._is48vEntity(e)||t.some(t=>this._is48vEntity(t.entity_id)||this._is48vEntity(t.name)),o=this._isHybridBatteryChargeEntity(i),l=Boolean(s||a||!o&&i)||Boolean(this._findEntity(t,["sensor","binary_sensor"],["electric range","ev range","charging","charge","charging port","traction battery","high voltage","hv battery","electric engine","state of energy"],new Set)),d=Boolean(n)||Boolean(this._findEntity(t,["sensor"],["fuel","tank","kraftstoff","tank level"],new Set));return l?d?"phev":"bev":r?"mhev":"ice"}_is48vEntity(t){return!!t&&this._normalizeText(t).includes("48v")}_isHybridBatteryChargeEntity(t){if(!t)return!1;const e=this._normalizeText(t);return e.includes("48v")||e.includes("12v")||e.includes("trip")||e.includes("end_of_trip")||e.includes("end of trip")||e.includes("bei ankunft")||e.includes("ankunft")||e.includes("arrival")||e.includes("trip_battery")||e.includes("charge level at end of trip")}_buildPwfStatusIconTemplate(t){return`{% set s = states('${t}') | lower %}{{ iif('driving' in s or 'fahrt' in s, 'mdi:car-sports', iif('parking' in s or 'parked' in s or 'parken' in s, 'mdi:parking', iif('standing' in s or 'stand' in s, 'mdi:car-brake-hold', 'mdi:car'))) }}`}_buildAlarmArmingIconTemplate(t){return`{% set s = states('${t}') | lower %}{{ iif(s == 'unarmed', 'mdi:shield-off', iif(s == 'doorsonly', 'mdi:car-door-lock', iif(s == 'doorstiltcabin', 'mdi:shield-car', 'mdi:shield-lock'))) }}`}_buildTirePairs(t,e){const i=new Map;e.forEach(t=>{const e=this._tirePositionKey(t);e&&i.set(e,t)});const s=[],a=[];return t.forEach(t=>{const e=this._tirePositionKey(t);if(!e)return;const n=i.get(e);n?s.push({a:t,t:n}):a.push(t)}),{pairs:s,fallback:a}}_buildLowFuelColorTemplate(t){return`{% set v = states('${t}') | float(0) %}{{ iif(v > 0 and v < 10, 'var(--error-color)', 'var(--primary-color)') }}`}_buildBatteryHealthColorTemplate(t){return`{% set v = states('${t}') | float(0) %}{{ iif(v < 80, 'var(--error-color)', iif(v < 90, 'var(--warning-color)', 'var(--success-color)')) }}`}_buildStatusBadges(){if(!this.hass||!this._statusEntities)return[];const t=[],e=this._statusEntities.fuel;if(e){const i=this.hass.states[e],s=Number(i?.state),a=i?.attributes?.unit_of_measurement;if(!Number.isNaN(s)){("%"===a?s<=15:s<=10)&&t.push({label:"Tank niedrig",level:"warning"})}}this._hasLowTirePressure()&&t.push({label:"Reifendruck niedrig",level:"alert"});return this._hasDoorsOpenWhileParked()&&t.push({label:"Öffnungen offen",level:"warning"}),t}_hasLowTirePressure(){if(!this.hass||!this._statusEntities)return!1;const t=this._statusEntities.tires||[],e=this._statusEntities.tireTargets||[];if(!t.length)return!1;const i=new Map;return e.forEach(t=>{const e=this.hass.states[t]?.state,s=Number(e);if(!Number.isNaN(s)){const e=this._tirePositionKey(t);e&&i.set(e,s)}}),t.some(t=>{const e=this.hass.states[t]?.state,s=Number(e);if(Number.isNaN(s))return!1;const a=this._tirePositionKey(t),n=a?i.get(a):void 0;return void 0!==n?s<.9*n:s<200})}_tirePositionKey(t){const e=this._normalizeText(t);return e.includes("front")&&e.includes("left")?"front_left":e.includes("front")&&e.includes("right")?"front_right":e.includes("rear")&&e.includes("left")?"rear_left":e.includes("rear")&&e.includes("right")?"rear_right":void 0}_hasDoorsOpenWhileParked(){if(!this.hass||!this._statusEntities)return!1;const t=this._getVehicleStatusLabel();if("parked"!==t&&"standing"!==t)return!1;return(this._statusEntities.doors||[]).some(t=>{const e=this.hass.states[t]?.state;if(!e)return!1;const i=this._normalizeText(e);return!["closed","geschlossen","secured","gesichert","locked","verriegelt","ok","aus"].some(t=>i.includes(t))})}render(){return this._error?D`
      ...
      `:customElements.get(dt)?this._vehicleConfig?D`
