        ...
        <div class="form">
          ...
          ${"ai"===t?D`
                ...
                <div class="actions">
                  ...
                  ${s?D`<div class="hint">Bilder werden nur nach Klick generiert (Cache aktiv).</div>`:D`<div class="hint">Auto-Generierung aktiv.</div>`}
                </div>
                ${"ha_ai_task"===i?D`
