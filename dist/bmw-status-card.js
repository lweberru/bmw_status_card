        ...
        <div class="form">
          ...
          ${"ai"===t?V`
                ...
                <div class="actions">
                  ...
                  ${r?V`<div class="hint">Bilder werden nur nach Klick generiert (Cache aktiv).</div>`:V`<div class="hint">Auto-Generierung aktiv.</div>`}
                </div>
                ${"ha_ai_task"===i?V`
                      ...
                      <div class="field">
                        ...
                        >
                          ...
                          ${a.map(t=>V`<option value=${t}>${t}</option>`)}
                        </select>
                      </div>
                      ${0===a.length?V`<div class="hint">Keine ai_task Entities gefunden.</div>`:null}
                    `:null}
