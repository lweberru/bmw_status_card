        ...
        <div class="form">
          ...
          ${"ai"===t?D`
                ...
                <div class="actions">
                  ...
                  ${a?D`<div class="hint">Bilder werden nur nach Klick generiert (Cache aktiv).</div>`:D`<div class="hint">Auto-Generierung aktiv.</div>`}
                </div>
                ${"ha_ai_task"===i?D`
                      ...
                      <div class="field">
                        ...
                        >
                          ...
                          ${s.map(t=>D`<option value=${t}>${t}</option>`)}
                        </select>
                      </div>
                      ${0===s.length?D`<div class="hint">Keine ai_task Entities gefunden.</div>`:null}
                    `:null}
