        ...
        <div class="form">
          ...
          ${"ai"===e?D`
                ...
                <div class="actions">
                  ...
                  ${c?D`<div class="hint">Bilder werden nur nach Klick generiert (Cache aktiv).</div>`:D`<div class="hint">Auto-Generierung aktiv.</div>`}
                </div>
                ${"ha_ai_task"===a?D`
                      ...
                      ${0===l.length?D`<div class="hint">Keine ai_task Entities gefunden.</div>`:null}
                    `:null}
                ${"openai"===a||"gemini"===a||"ha_ai_task"===a?D`
                      <div class="row">
                        <div class="field">
                ...
                ${"generic"!==a?D`
                      <div class="row">
                        ${"gemini"===a&&this._geminiModels?.length?D`
                              <div class="field">
                            ...
                            `:"openai"===a&&this._openAiModels?.length?D`
                                <div class="field">
                    ...
                    `}
                ${"gemini"===a&&this._geminiModelsLoading?D`<div class="hint">Lade Gemini-Modelle…</div>`:null}
                ${"gemini"===a&&this._geminiModelsError?D`<div class="hint">${this._geminiModelsError}</div>`:null}
                ${"openai"===a&&this._openAiModelsLoading?D`<div class="hint">Lade OpenAI-Modelle…</div>`:null}
                ${"openai"===a&&this._openAiModelsError?D`<div class="hint">${this._openAiModelsError}</div>`:null}
                <div class="row">
                  ${"gemini"===a?D`
                        <div class="field">
