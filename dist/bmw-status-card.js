 ...
 */class ot extends ${constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const t=super.createRenderRoot();return this.renderOptions.renderBefore??=t.firstChild,t}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{const s=i?.renderBefore??e;let a=s._$litPart$;if(void 0===a){const t=i?.renderBefore??null;s._$litPart$=a=new Q(e.insertBefore(P(),t),t,void 0,i??{})}return a._$AI(t),a})(e,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return D}}ot._$litElement$=!0,ot.finalized=!0,nt.litElementHydrateSupport?.({LitElement:ot});const rt=nt.litElementPolyfillSupport;rt?.({LitElement:ot}),(nt.litElementVersions??=[]).push("4.2.2");const lt="bmw-status-card",dt="vehicle-status-card",ht="High-quality photo of a {year} {color} {make} {model} {series} {trim} {body}, {angle}, clean studio background, realistic, sharp details.";class ct extends ot{constructor(){super(...arguments),this._loading=!1}static{this.properties={hass:{attribute:!1},_config:{state:!0},_vehicleConfig:{state:!0},_error:{state:!0},_loading:{state:!0},_vehicleInfo:{state:!0}}}static{this.styles=n`
  ...
  `}set hass(t){this._hass=t,this._ensureConfig()}get hass(){return this._hass}setConfig(t){this._config=t,this._vehicleConfig=void 0,this._error=void 0,t?.bmw_home_device_id&&t?.bmw_cardata_device_id||(this._error="bmw_home_device_id und bmw_cardata_device_id sind erforderlich."),this._vehicleInfo=void 0,this._entityEntriesCache=void 0,this._deviceEntriesCache=void 0,this._ensureVehicleCardLoaded(),this._ensureConfig()}updated(){const t=this.renderRoot.querySelector(dt);t&&this.hass&&(t.hass=this.hass,this._vehicleConfig&&t.setConfig(this._vehicleConfig))}getCardSize(){return 6}static getConfigElement(){return document.createElement("bmw-status-card-editor")}static getStubConfig(){return{type:`custom:${lt}`,bmw_home_device_id:"",bmw_cardata_device_id:""}}async _ensureVehicleCardLoaded(){if(!this._config?.vehicle_status_card_resource)return;if(customElements.get(dt))return;document.querySelector(`script[data-bmw-status-card="${this._config.vehicle_status_card_resource}"]`)||await new Promise((t,e)=>{const i=document.createElement("script");i.type="module",i.src=this._config.vehicle_status_card_resource,i.dataset.bmwStatusCard=this._config.vehicle_status_card_resource,i.addEventListener("load",()=>t()),i.addEventListener("error",()=>e()),document.head.appendChild(i)})}async _ensureConfig(){if(this.hass&&this._config&&!this._loading&&!this._vehicleConfig&&this._config.bmw_home_device_id&&this._config.bmw_cardata_device_id){this._loading=!0;try{console.debug("[bmw-status-card] building config");const t=[this._config.bmw_home_device_id,this._config.bmw_cardata_device_id].filter(Boolean),e=await this._getEntityRegistry(),i=await this._getDeviceRegistry(),s=this._buildEntityInfo(e,t),a=this._buildVehicleInfo(i,s);this._vehicleInfo=a;const n=await this._resolveImages(a),o=this._buildVehicleStatusCardConfig(s,n);this._vehicleConfig=this._mergeVehicleConfig(o,this._config.vehicle_status_card),this._error=void 0}catch(t){this._error=t?.message||String(t),console.error("[bmw-status-card] config build failed:",t)}finally{this._loading=!1,this.requestUpdate()}}}async _getEntityRegistry(){if(this._entityEntriesCache)return this._entityEntriesCache;const t=await this.hass.callWS({type:"config/entity_registry/list"});return this._entityEntriesCache=t,t}async _getDeviceRegistry(){if(this._deviceEntriesCache)return this._deviceEntriesCache;const t=await this.hass.callWS({type:"config/device_registry/list"});return this._deviceEntriesCache=t,t}_buildEntityInfo(t,e){const i=new Set(e);return t.filter(t=>t.device_id&&i.has(t.device_id)).map(t=>{const e=this.hass.states[t.entity_id],i=t.entity_id.split(".")[0],s=e?.attributes?.friendly_name||t.original_name||t.entity_id;return{entity_id:t.entity_id,domain:i,name:s,device_class:e?.attributes?.device_class,unit:e?.attributes?.unit_of_measurement,state:e?.state,attributes:e?.attributes||{}}})}_extractVehicleInfoFromAttributes(t){const e={};for(const i of t){const t=i.attributes||{},s=t.vehicle_basic_data||t.vehicleBasicData,a=t.vehicle_basic_data_raw||t.vehicleBasicDataRaw;s&&"object"==typeof s&&(e.model=e.model||this._toNonEmptyString(s.model_name),e.series=e.series||this._toNonEmptyString(s.series),e.color=e.color||this._toNonEmptyString(s.color),e.body=e.body||this._toNonEmptyString(s.body_type),e.year=e.year||this._extractYear(s.construction_date)),a&&"object"==typeof a&&(e.make=e.make||this._toNonEmptyString(a.brand),e.model=e.model||this._toNonEmptyString(a.modelName)||this._toNonEmptyString(a.modelRange)||this._toNonEmptyString(a.series),e.series=e.series||this._toNonEmptyString(a.series)||this._toNonEmptyString(a.seriesDevt),e.color=e.color||this._toNonEmptyString(a.colourDescription)||this._toNonEmptyString(a.colourCodeRaw),e.body=e.body||this._toNonEmptyString(a.bodyType),e.year=e.year||this._extractYear(a.constructionDate))}return e}_extractYear(t){if(t){if("number"==typeof t)return String(t);if("string"==typeof t){const e=t.match(/(19|20)\d{2}/);return e?e[0]:void 0}}}_toNonEmptyString(t){if(null==t)return;const e=String(t).trim();return e.length?e:void 0}_buildVehicleInfo(t,e){const i=this._config?.vehicle_info||{},s=[this._config?.bmw_home_device_id,this._config?.bmw_cardata_device_id],a=t.filter(t=>s.includes(t.id)),n=this._extractVehicleInfoFromAttributes(e),o=a.find(t=>t.manufacturer)?.manufacturer||"BMW",r=a.find(t=>t.model)?.model,l=a.find(t=>t.name)?.name,d=this._findEntityByKeywords(e,["model","vehicle_model","car_model"]),h=this._findEntityByKeywords(e,["series","line"]),c=this._findEntityByKeywords(e,["year","model_year"]),p=this._findEntityByKeywords(e,["color","colour"]),_=this._findEntityByKeywords(e,["trim","package","edition"]),u=this._findEntityByKeywords(e,["body","body_type"]),m=t=>{if(!t)return;const e=this.hass.states[t]?.state;return e&&"unknown"!==e&&"unavailable"!==e?e:void 0};return{make:i.make||n.make||o,model:i.model||n.model||m(d)||r,series:i.series||n.series||m(h),year:i.year||n.year||m(c),color:i.color||n.color||m(p),trim:i.trim||n.trim||m(_),body:i.body||n.body||m(u),name:i.name||n.name||l}}async _resolveImages(t){const e=this._config?.image;if(!e||"off"===e.mode)return[];if("static"===e.mode&&e.static_urls?.length)return e.static_urls;if("ai"===e.mode&&e.ai){const i=e.ai.provider||"ha_ai_task";return"openai"!==i&&"gemini"!==i||e.ai.api_key?(console.debug("[bmw-status-card] generating AI images",e.ai),this._generateAiImages(t,e.ai)):(console.warn("[bmw-status-card] image.ai.api_key fehlt – überspringe Bildgenerierung."),[])}return[]}async _generateAiImages(t,e){const i=e.provider||"ha_ai_task",s=e.cache_hours??24,a=this._buildImageCacheKey(t,e),n=this._buildPrompts(t,e),o=e.count??1,r=e.max_images??8,l=!1!==e.generate_on_demand,d=e.download??("openai"===i||"gemini"===i),h=e.upload??!1;try{const t=localStorage.getItem(a);if(t){const e=JSON.parse(t),i=(Date.now()-e.timestamp)/36e5;if(e.images?.length&&i<=s)return e.images}}catch(t){}if(l&&!e.generate_request_id)return[];let c=[];for(const t of n){if(c.length>=r)break;const s=r-c.length,a=Math.min(o,s);if(a<=0)break;"openai"===i?c.push(...await this._fetchOpenAiImages(t,e,a)):"gemini"===i?c.push(...await this._fetchGeminiImages(t,e,a)):"ha_ai_task"===i?c.push(...await this._fetchHaAiTaskImages(t,e,a)):c.push(...await this._fetchGenericImages(t,e,a))}if(c.length)try{localStorage.setItem(a,JSON.stringify({timestamp:Date.now(),images:c}))}catch(t){}return c.length&&h?c=await this._uploadImagesIfNeeded(c,e):c.length&&d&&(c=await this._downloadImagesIfNeeded(c,e)),c}_buildPrompts(t,e){const i=e.prompt_template||ht;if(e.prompts&&e.prompts.length)return e.prompts.map(e=>this._buildPrompt(t,e));return(e.views?.length?e.views:["front 3/4 view","rear 3/4 view","side profile","front view","rear view"]).map(e=>this._buildPrompt(t,i,e))}_buildPrompt(t,e,i){const s=e||ht,a={"{make}":t.make||"BMW","{model}":t.model||"","{series}":t.series||"","{year}":t.year||"","{color}":t.color||"","{trim}":t.trim||"","{body}":t.body||"","{angle}":i||""};let n=s;return Object.entries(a).forEach(([t,e])=>{const i=e?.trim();n=n.replaceAll(t,i||"")}),i&&!s.includes("{angle}")&&(n=`${n} ${i}`),n.replace(/\s+/g," ").trim()}async _fetchOpenAiImages(t,e,i){if(!e.api_key)throw new Error("image.ai.api_key fehlt (OpenAI).");const s=e.endpoint||"https://api.openai.com/v1/images/generations",a={model:e.model||"gpt-image-1",prompt:t,size:e.size||"1024x1024",n:i},n=await fetch(s,{method:"POST",headers:{Authorization:`Bearer ${e.api_key}`,"Content-Type":"application/json"},body:JSON.stringify(a)});if(!n.ok){const t=await n.text();throw new Error(`OpenAI Fehler: ${n.status} ${t}`)}const o=await n.json();return(o?.data||[]).map(t=>t.url||t.b64_json).filter(Boolean).map(t=>t.startsWith("http")?t:`data:image/png;base64,${t}`)}async _fetchGeminiImages(t,e,i){if(!e.api_key)throw new Error("image.ai.api_key fehlt (Gemini).");const s=e.model||"imagen-3.0-generate-002",a=e.endpoint||`https://generativelanguage.googleapis.com/v1beta/models/${s}:generateContent?key=${e.api_key}`,n=e=>{const s={contents:[{role:"user",parts:[{text:t}]}],generationConfig:{candidateCount:i}};return e&&(s.responseModalities=["IMAGE"]),s},o=e.request_body||n(!0),r=async t=>await fetch(a,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)});let l=await r(o),d="";if(!l.ok){d=await l.text();if(!(!e.request_body&&(d.includes("response_modalities")||d.includes("responseModalities")||d.includes("imageGenerationConfig")||d.includes("generation_config"))))throw new Error(`Gemini Fehler: ${l.status} ${d}`);if(l=await r(n(!1)),!l.ok){const t=await l.text();throw new Error(`Gemini Fehler: ${l.status} ${t}`)}}const h=await l.json(),c=h?.candidates||[],p=[];if(Array.isArray(c)&&c.forEach(t=>{"SAFETY"===t?.finishReason&&console.warn("[bmw-status-card] Gemini Bild durch Safety-Filter blockiert.");(t?.content?.parts||[]).forEach(t=>{const e=t.inlineData||t.inline_data;if(e?.data){const t=e.mimeType||"image/png";p.push(`data:${t};base64,${e.data}`)}})}),p.length)return p;const _=h?.predictions||h?.images||h?.data||[];return Array.isArray(_)?_.map(t=>{const e=t.bytesBase64Encoded||t?.image?.bytesBase64Encoded||t?.b64_json;return e?`data:image/png;base64,${e}`:"string"==typeof t&&t.startsWith("http")?t:t?.url?t.url:null}).filter(Boolean):[]}async _fetchHaAiTaskImages(t,e,i){if(!this.hass)throw new Error("Home Assistant nicht verfügbar.");const s={};e.ha_entity_id&&(s.entity_id=e.ha_entity_id),e.model&&(s.model=e.model),e.size&&(s.size=e.size),e.aspect_ratio&&(s.aspect_ratio=e.aspect_ratio),e.request_body&&Object.assign(s,e.request_body);const a=this._vehicleInfo?.name||this._config?.vehicle_info?.name||"BMW Status Card",n=[{task_name:a,instructions:t},{task_name:a,instructions:t,n:i},{prompt:t,n:i},{prompt:t},{text:t,n:i},{text:t},{input:t,n:i},{input:t},{task:t,n:i},{task:t},{description:t,n:i},{description:t}];let o,r;for(const t of n)try{o=await this.hass.callWS({type:"call_service",domain:"ai_task",service:"generate_image",service_data:{...s,...t},return_response:!0}),r=void 0;break}catch(t){r=t}if(!o)throw new Error(`ai_task Fehler: ${r?.message||String(r)}`);const l=o?.response??o?.result??o;return(await this._extractHaAiTaskUrls(l)).filter(Boolean)}async _downloadImagesIfNeeded(t,e){if(!this.hass)return t;const i=this._normalizeDownloadPath(e.download_path),s=[];for(const e of t){if(!this._isHttpUrl(e)){s.push(e);continue}const t=this._guessImageExtension(e),a=`${i}/${this._hash(e)}.${t}`;try{await this.hass.callWS({type:"call_service",domain:"downloader",service:"download",service_data:{url:e,filename:a}});const t=a.startsWith("www/")?a.slice(4):a;s.push(`/local/${t}`)}catch(t){s.push(e)}}return s}async _uploadImagesIfNeeded(t,e){if(!this.hass)return t;const i=this._normalizeUploadPath(e.upload_path),s=[];for(const e of t){let t,a,n;if(this._isHttpUrl(e))t=e;else{const t=this._parseDataUrl(e);if(!t){s.push(e);continue}a=t.data,n=t.mimeType}const o=this._guessImageExtension(t,n),r=t||a||e,l=`${this._hash(r)}.${o}`;try{const n=await this.hass.callWS({type:"call_service",domain:"upload_file",service:"upload_file",service_data:{path:i,filename:l,...t?{url:t}:{data_base64:a}},return_response:!0}),o=n?.response??n?.result??n,r=o?.local_url||o?.url||o?.local_path;s.push(r||e)}catch(t){s.push(e)}}return s}_normalizeUploadPath(t){const e=(t||"www/upload_file").replace(/^\/+/,"").replace(/\/+$/,"");return e.startsWith("www/")?e:`www/${e}`}_parseDataUrl(t){if(!t.startsWith("data:"))return null;const e=t.match(/^data:([^;]+);base64,(.*)$/);return e?{mimeType:e[1],data:e[2]}:null}_guessImageExtension(t,e){if(e){if(e.includes("png"))return"png";if(e.includes("jpeg")||e.includes("jpg"))return"jpg";if(e.includes("webp"))return"webp"}if(t){const e=t.match(/\.(png|jpg|jpeg|webp)(\?|$)/i);if(e)return e[1].toLowerCase().replace("jpeg","jpg")}return"png"}_normalizeDownloadPath(t){const e=(t||"www/bmw_status_card").replace(/^\/+/,"").replace(/\/+$/,"");return e.startsWith("www/")?e:`www/${e}`}_isHttpUrl(t){return t.startsWith("http://")||t.startsWith("https://")}async _extractHaAiTaskUrls(t){if(!t)return[];const e=t?.images||t?.data||t?.results||t?.result||t,i=Array.isArray(e)?e:[e],s=[];for(const t of i){if(!t)continue;if("string"==typeof t){s.push(t);continue}const e=t.url||t.image_url||t.media_url||t.content_url||t.media?.url||t.image?.url;if(e){s.push(e);continue}const i=t.media_id||t.media_content_id||t.content_id||t.media;if(i){const t=await this._resolveMediaSourceUrl(String(i));t?s.push(t):s.push(`/api/media/${i}`)}}return s}async _resolveMediaSourceUrl(t){if(this.hass&&t)try{if(t.startsWith("http"))return t;const e=await this.hass.callWS({type:"media_source/resolve",media_content_id:t});return e?.url}catch(t){return}}async _fetchGenericImages(t,e,i){if(!e.endpoint)throw new Error("image.ai.endpoint fehlt (generic).");const s=e.request_body||{prompt:t,count:i,size:e.size},a=await fetch(e.endpoint,{method:"POST",headers:{...e.api_key?{Authorization:`Bearer ${e.api_key}`}:{},"Content-Type":"application/json"},body:JSON.stringify(s)});if(!a.ok){const t=await a.text();throw new Error(`AI Fehler: ${a.status} ${t}`)}const n=await a.json(),o=this._extractByPath(n,e.response_path)||n.images||n.data||[];return Array.isArray(o)?o.map(t=>"string"==typeof t?t:t.url||t.image||t.b64_json).filter(Boolean).map(t=>t.startsWith("http")?t:`data:image/png;base64,${t}`):[]}_extractByPath(t,e){if(e)return e.split(".").reduce((t,e)=>t?t[e]:void 0,t)}_buildImageCacheKey(t,e){const i={vehicleInfo:t,provider:e.provider,model:e.model,size:e.size,aspect_ratio:e.aspect_ratio,count:e.count,max_images:e.max_images,download:e.download,download_path:e.download_path,upload:e.upload,upload_path:e.upload_path,prompt_template:e.prompt_template,prompts:e.prompts,views:e.views,generate_request_id:!1!==e.generate_on_demand?e.generate_request_id:void 0};return`bmw-status-card:images:${this._hash(JSON.stringify(i))}`}_hash(t){let e=0;for(let i=0;i<t.length;i+=1)e=(e<<5)-e+t.charCodeAt(i),e|=0;return String(e)}_buildVehicleStatusCardConfig(t,e){const i=new Set,s=this._pickEntity(t,i,["lock","binary_sensor","sensor"],["lock","locked","door lock"]),a=this._pickEntity(t,i,["binary_sensor","sensor"],["charging","charge","plugged","plug","charging port","connector","port"]),n=this._pickEntity(t,i,["sensor"],["battery","soc","state_of_charge","state of charge","state_of_energy","soe"]),o=this._pickEntity(t,i,["sensor"],["fuel","tank","fuel_level"]),r=this._pickEntity(t,i,["sensor"],["range","remaining","remaining_range","remainingrange"]),l=this._pickEntity(t,i,["sensor"],["electric range","ev range","remaining electric range","kombi remaining electric range"]),d=this._pickEntity(t,i,["sensor"],["fuel range","remaining fuel","tank level"]),h=this._pickEntity(t,i,["sensor"],["total remaining range","total range"]),c=this._pickEntity(t,i,["sensor","number"],["target","charge target","target soc","target state"]),p=this._pickEntity(t,i,["sensor"],["odometer","mileage","distance","travelled"]),_=this._pickEntity(t,i,["sensor"],["temperature","temp","coolant"]),u=this._pickEntity(t,i,["sensor"],["charging power","charge power","power","grid energy"]),m=this._pickEntity(t,i,["sensor"],["time remaining","time to fully","time to full","remaining time"]),g=this._pickEntity(t,i,["binary_sensor","sensor","switch"],["preconditioning","climatization","climate","hvac","defrost"]),f=this._pickEntity(t,i,["binary_sensor","sensor"],["engine","ignition"]),y=this._pickEntity(t,i,["binary_sensor","sensor"],["moving","motion","driving","parking"]),v=this._pickEntity(t,i,["binary_sensor","sensor"],["alarm","anti theft","anti-theft"]),w=[];s&&w.push({type:"entity",entity:s,icon:"mdi:lock"}),a&&w.push({type:"entity",entity:a,icon:"mdi:ev-station"}),n&&w.push({type:"entity",entity:n,icon:"mdi:battery"}),o&&w.push({type:"entity",entity:o,icon:"mdi:gas-station"}),g&&w.push({type:"entity",entity:g,icon:"mdi:car-defrost-front"});const $=[];(l||h||r)&&$.push({type:"entity",entity:l||h||r,icon:"mdi:map-marker-distance"}),p&&$.push({type:"entity",entity:p,icon:"mdi:counter"}),_&&$.push({type:"entity",entity:_,icon:"mdi:thermometer"}),u&&$.push({type:"entity",entity:u,icon:"mdi:flash"}),m&&$.push({type:"entity",entity:m,icon:"mdi:timer"}),f&&$.push({type:"entity",entity:f,icon:"mdi:engine"}),y&&$.push({type:"entity",entity:y,icon:"mdi:car"}),v&&$.push({type:"entity",entity:v,icon:"mdi:alarm-light"});const b=this._pickEntities(t,i,["binary_sensor","sensor","cover"],["door","window","trunk","tailgate","boot","hood","bonnet","sunroof","roof","flap","lock","flap","charging port","port"]),E=this._pickEntities(t,i,["sensor"],["tire","tyre","pressure","wheel","tpms","pressure target"]),A=this._pickEntities(t,i,["sensor"],["tire temperature","tyre temperature","wheel temperature"]),k=this._pickEntities(t,i,["binary_sensor","sensor","switch"],["light","lights","headlight","lamp","running light"]),C=this._pickEntities(t,i,["binary_sensor","sensor","switch","climate"],["climate","hvac","preconditioning","defrost","seat","steering wheel","air purification","heater","heating","cooling"]),S=this._pickEntities(t,i,["sensor","binary_sensor"],["service","inspection","cbs","check control","maintenance"]),x=this._pickEntities(t,i,["sensor","device_tracker"],["navigation","destination","eta","latitude","longitude","gps"]),M=this._pickEntities(t,i,["sensor","binary_sensor","switch","number"],["charging","charge","plug","connector","charging mode","charging power","time to fully","charge target"]),I=[];if(w.length&&I.push({row_items:w,alignment:"center",no_wrap:!0}),$.length&&I.push({row_items:$,alignment:"center",no_wrap:!0}),b.length||E.length){const t=[];b.length&&t.push({type:"group",name:"Öffnungen",icon:"mdi:car-door",items:b.map(t=>({type:"entity",entity:t}))});const e=[...E,...A];e.length&&t.push({type:"group",name:"Reifen",icon:"mdi:car-tire-alert",items:e.map(t=>({type:"entity",entity:t}))}),t.length&&I.push({row_items:t,alignment:"center",no_wrap:!0})}const P=[];M.length&&P.push({type:"group",name:"Laden",icon:"mdi:ev-station",items:M.map(t=>({type:"entity",entity:t}))}),C.length&&P.push({type:"group",name:"Klima",icon:"mdi:car-defrost-front",items:C.map(t=>({type:"entity",entity:t}))}),k.length&&P.push({type:"group",name:"Licht",icon:"mdi:car-light-high",items:k.map(t=>({type:"entity",entity:t}))}),S.length&&P.push({type:"group",name:"Service",icon:"mdi:wrench",items:S.map(t=>({type:"entity",entity:t}))}),x.length&&P.push({type:"group",name:"Navigation",icon:"mdi:navigation",items:x.map(t=>({type:"entity",entity:t}))}),P.length&&I.push({row_items:P,alignment:"center",no_wrap:!0});const O=[];n&&O.push({energy_level:{entity:n},range_level:l||h||r?{entity:l||h||r}:void 0,charging_entity:a||void 0,charge_target_entity:c||void 0}),o&&O.push({energy_level:{entity:o},range_level:d||h||r?{entity:d||h||r}:void 0}),!O.length&&r&&O.push({energy_level:{entity:r}});const T=t.filter(t=>"device_tracker"===t.domain).map(t=>t.entity_id),B=T[0],L=this._buildTireCardConfig(t),N=new Set(L?.entities||[]),U=[],H=[],z=[],R=(t,e,i,s)=>{e&&t.push({entity:e,name:i,icon:s})};R(H,n,"Batterie","mdi:battery"),R(H,o,"Kraftstoff","mdi:gas-station"),R(H,l||h||r,"Reichweite","mdi:map-marker-distance"),R(H,p,"Kilometerstand","mdi:counter"),R(H,_,"Temperatur","mdi:thermometer"),R(H,m,"Ladezeit","mdi:timer"),R(H,u,"Ladeleistung","mdi:flash"),S.forEach(t=>R(z,t)),H.length&&(U.push({name:"Fahrzeug",icon:"mdi:car-info",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Fahrzeugstatus",items:H}]}}),H.forEach(t=>N.add(t.entity))),z.length&&(U.push({name:"Service",icon:"mdi:wrench",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Service",items:z}]}}),z.forEach(t=>N.add(t.entity))),M.length&&(U.push({name:"Laden",icon:"mdi:ev-station",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Ladezustand",items:M.map(t=>({entity:t}))}]}}),M.forEach(t=>N.add(t))),C.length&&(U.push({name:"Klima",icon:"mdi:car-defrost-front",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Klima",items:C.map(t=>({entity:t}))}]}}),C.forEach(t=>N.add(t))),x.length&&(U.push({name:"Navigation",icon:"mdi:navigation",button_type:"default",card_type:"default",sub_card:{default_card:[{title:"Navigation",items:x.map(t=>({entity:t}))}]}}),x.forEach(t=>N.add(t)));const j=[...U,...this._buildButtonCards(t,i,N)],V=e.length?e.map(t=>({image:t})):void 0;return{type:`custom:${dt}`,name:this._vehicleInfo?.name||"BMW",indicator_rows:I.length?I:void 0,range_info:O.length?O:void 0,button_cards:j.length?j:void 0,images:V,mini_map:B?{device_tracker:B,entities:T,maptiler_api_key:this._config?.maptiler_api_key,enable_popup:!0,map_height:240,map_zoom:14,user_location:!0,use_zone_name:!0}:void 0,layout_config:{section_order:["indicators","range_info","images","mini_map","buttons"],button_grid:{columns:2,swipe:!0},images_swipe:{autoplay:!0,loop:!0,delay:6e3,speed:600,effect:"fade",height:240},range_info_config:{layout:"row"},single_tire_card:L?.tire_card?{enabled:!0,tire_card:L.tire_card}:void 0}}}_buildButtonCards(t,e,i){const s=["lock","switch","button","cover","climate"],a=new Set([...e,...i?Array.from(i):[]]),n=t.filter(t=>!a.has(t.entity_id)).sort((t,e)=>{const i=s.indexOf(t.domain),a=s.indexOf(e.domain);return(-1===i?999:i)-(-1===a?999:a)}),o=[];for(const t of n){if(o.length>=12)break;s.includes(t.domain)&&(e.add(t.entity_id),a.add(t.entity_id),o.push({entity:t.entity_id,name:t.name,button_type:"default"}))}return o}_mergeVehicleConfig(t,e){if(!e)return t;const i={...t,...e};return["indicator_rows","range_info","images","button_cards"].forEach(t=>{void 0!==e[t]&&(i[t]=e[t])}),void 0!==e.mini_map&&(i.mini_map=e.mini_map),void 0!==e.layout_config&&(i.layout_config=e.layout_config),i}_pickEntity(t,e,i,s){const a=this._findEntity(t,i,s,e);if(a)return e.add(a.entity_id),a.entity_id}_pickEntities(t,e,i,s){const a=this._findEntities(t,i,s,e);return a.forEach(t=>e.add(t.entity_id)),a.map(t=>t.entity_id)}_findEntity(t,e,i,s){return this._findEntities(t,e,i,s)[0]}_findEntities(t,e,i,s){const a=i.map(t=>t.toLowerCase());return t.filter(t=>!s.has(t.entity_id)).filter(t=>!e.length||e.includes(t.domain)).filter(t=>{if(!a.length)return!0;const e=`${t.entity_id} ${t.name} ${t.device_class??""}`.toLowerCase();return a.some(t=>e.includes(t))}).sort((t,e)=>{const i=t.state||"",s=e.state||"";return"unknown"===i&&"unknown"!==s?1:"unknown"===s&&"unknown"!==i?-1:t.name.localeCompare(e.name)})}_findEntityByKeywords(t,e){return this._findEntity(t,[],e,new Set)?.entity_id}_buildTireCardConfig(t){const e=e=>this._findEntity(t,["sensor"],e,new Set),i=e(["front left","front_left","row1 left","row1 wheel left"]),s=e(["front right","front_right","row1 right","row1 wheel right"]),a=e(["rear left","rear_left","row2 left","row2 wheel left"]),n=e(["rear right","rear_right","row2 right","row2 wheel right"]),o=[i,s,a,n].filter(Boolean).map(t=>t.entity_id);if(!o.length)return;return{tire_card:{title:"Reifendruck",front_left:i?{entity:i.entity_id,name:"Vorne links"}:void 0,front_right:s?{entity:s.entity_id,name:"Vorne rechts"}:void 0,rear_left:a?{entity:a.entity_id,name:"Hinten links"}:void 0,rear_right:n?{entity:n.entity_id,name:"Hinten rechts"}:void 0},entities:o}}render(){return this._error?V`
        <ha-card>
          <div class="message error">${this._error}</div>
        </ha-card>
      `:customElements.get(dt)?this._vehicleConfig?V`<vehicle-status-card></vehicle-status-card>`:V`
        <ha-card>
                      ...
                      <div class="row">
                        ...
                        ${a?V`
                              <ha-textfield
                                ...
                                .value=${e.download_path||"www/bmw_status_card"}
